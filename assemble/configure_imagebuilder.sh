...
echo "src/gz ffweimar_packages http://buildbot.weimarnetz.de/builds/brauhaus/$(git describe --always --dirty --tags)/$OPENWRT/$MAINTARGET/$CUSTOMTARGET/packages" > ./EMBEDDED_FILES/etc/opkg/customsfeeds.conf
